  ...
  const projects: Project[] = [
    {
      ...
      demo: "https://janrusell-portfolio.vercel.app/",
      status: "Completed",
      highlights: [
            ...
            <CardContent className="p-6 space-y-4 text-gray-700 dark:text-neutral-300">
              ...
              <div className="space-y-1">
                {project.highlights.map((highlight, idx) => (
                  <div
                    key={idx}
                    className="text-xs font-mono text-cyan-400 flex items-start gap-2"
                  >
      ...
      <Card className="bg-white dark:bg-neutral-900 border border-gray-300 dark:border-neutral-800 mt-8">
        <CardContent className="p-6 text-center text-gray-700 dark:text-neutral-300">
          <div className="font-mono text-sm space-y-2">
            <div>
              <span className="text-cyan-400">$</span> git commit -m &quot;More
              projects coming soon...&quot;
            </div>
            <div>
              <span className="text-cyan-400">→</span> Currently learning and
              building
            </div>
